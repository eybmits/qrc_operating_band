...
\textbf{Code and data availability.} Code, checked-in CSV/JSON artifacts, generated figures, and the reproduction script are available in the \href{https://github.com/eybmits/qrc_phase_diagram}{project repository}.
