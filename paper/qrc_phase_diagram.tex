...
Band statistics & \texttt{data/phase\_map\_generalization\_stats.json}: band sizes, connectedness, leave-one-task/seed bootstrap CIs, ablation retention, and diagnostic correlations.\\
