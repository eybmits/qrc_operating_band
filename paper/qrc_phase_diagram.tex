...
\subsection{Package}
The \href{https://github.com/eybmits/qrc_phase_diagram}{\textcolor{repoLinkBlue}{project repository}} contains the code, checked-in CSV/JSON results, and final figures used in this paper.
